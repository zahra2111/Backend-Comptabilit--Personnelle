...
/* user/show.html.twig */
class __TwigTemplate_ebe564126e712b2a4ecfb67759fc3e7b534b786528550cfd1201439e152a86cf extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        yield "</td>
            ...
            <tr>
                ...
                <td>";
        // line 16
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 16, $this->source); })()), "NomPrenom", [], "any", false, false, false, 16), "html", null, true);
        yield "</td>
            </tr>
            <tr>
                <th>Password</th>
...
{% endblock %}
", "user/show.html.twig", "C:\\Users\\Zahra\\OneDrive\\Bureau\\backend\\templates\\user\\show.html.twig");
    }
}
